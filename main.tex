...
\usepackage[a4paper,left=22mm,right=22mm,top=20mm,bottom=24mm,headheight=14pt,includehead,includefoot]{geometry}

% XeLaTeX font system: Latin Modern body + mono
\usepackage{lmodern}
\usepackage{fontspec}
...
\fancyhead[L]{\small\CourseTitle\ ·\ \AssignmentTitle}
